...
var Sentencia_While = /** @class */ (function (_super) {
    __extends(Sentencia_While, _super);
    function Sentencia_While(p_evaluacion, p_lista_instrucciones) {
        var _this = _super.call(this, 0, 0) || this;
        _this.evaluacion = p_evaluacion;
        _this.lista_instrucciones = p_lista_instrucciones;
        return _this;
    }
    Sentencia_While.prototype.ejecutar = function (entorno_padre, ptr_entorno, etiqueta_retorno) {
        try {
            ...
            Tabla_Simbolos_1.default.classCodigo_3D = "if(" + comparacion_f.classValor + " ) goto " + etiqueta_ejecucion + ";\n";
...
exports.default = Sentencia_While;
