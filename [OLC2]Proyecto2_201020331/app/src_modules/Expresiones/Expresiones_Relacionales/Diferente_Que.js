...
var Diferente_Que = /** @class */ (function (_super) {
    ...
    Diferente_Que.prototype.ejecutar = function (entorno_padre, ptr_entorno) {
        ...
        try {
            ...
            switch (tipo_diferente_que) {
                ...
                case 60 /* diferente_booleano */:
                    ...
                    resultado.classValor = valor1.classValor + " != " + valor2.classValor;
                    return resultado;
                case 61 /* diferente_numerico_caracter */:
                    resultado.classAcceso = 0 /* publico */;
                    resultado.classRol = 9 /* aceptado */;
                    resultado.classTipo = 1 /* booleano */;
                    resultado.classIdentificador = "10-4";
                    resultado.classValor = valor1.classValor + " != " + valor2.classValor;
                    return resultado;
                case 62 /* diferente_caracter_numerico */:
                    resultado.classAcceso = 0 /* publico */;
                    resultado.classRol = 9 /* aceptado */;
                    resultado.classTipo = 1 /* booleano */;
                    resultado.classIdentificador = "10-4";
    ...
    Diferente_Que.prototype.evaluar = function (entorno_padre, ptr_entorno) {
        var tipo_diferente_que;
        var valor1;
        var valor2;
        var resultado;
