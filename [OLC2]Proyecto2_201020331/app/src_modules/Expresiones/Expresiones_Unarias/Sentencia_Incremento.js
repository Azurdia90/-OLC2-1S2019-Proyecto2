...
var Sentencia_Incremento = /** @class */ (function (_super) {
    __extends(Sentencia_Incremento, _super);
    function Sentencia_Incremento(operador, p_tipo, p_posicion) {
    ...
    return Sentencia_Incremento;
}(Expresion_1.default));
exports.default = Sentencia_Incremento;
