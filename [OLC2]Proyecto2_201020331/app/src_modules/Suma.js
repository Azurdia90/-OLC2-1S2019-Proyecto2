        ...
        try {
            ...
            switch (tipo_suma) {
                ...
                case 1 /* suma_decimal */:
                    ...
                    resultado.classRol(Tabla_Enums.tipo_Simbolo.aceptado);
                    resultado.classAcceso(Tabla_Enums.tipo_Acceso.publico);
                    resultado.classIdentificador("10-4");
                    resultado.classTipo(Tabla_Enums.tipo_primitivo_Simbolo.decimal);
                    resultado.classValor(formatearDecimales(resultado_final_double, 4));
                    return resultado;
                case 2 /* suma_entero_caracter */:
                    val1_entero = Integer.parseInt(valor1.getValor().toString());
                    val2_entero = (int);
                    valor2.getValor().toString().charAt(0);
                    resultado_final_entero = val1_entero + val2_entero;
                    resultado.classRol(Tabla_Enums.tipo_Simbolo.aceptado);
                    resultado.classAcceso(Tabla_Enums.tipo_Acceso.publico);
                    resultado.classIdentificador("10-4");
                    resultado.classTipo(Tabla_Enums.tipo_primitivo_Simbolo.entero);
                    resultado.classValor(resultado_final_entero);
                    return resultado;
                case 3 /* suma_caracter_entero */:
                    val1_entero = (int);
                    valor1.getValor().toString().charAt(0);
                ...
                case 37 /* concatenacion */:
                    String;
                    val1_cadena = valor1.getValor().toString();
                    String;
                    val2_cadena = valor2.getValor().toString();
                    String;
                    resultado_final_cadena = val1_cadena + val2_cadena;
                    resultado.classRol(Tabla_Enums.tipo_Simbolo.aceptado);
                    resultado.classAcceso(Tabla_Enums.tipo_Acceso.publico);
                    resultado.classIdentificador("10-4");
                    resultado.classTipo(Tabla_Enums.tipo_primitivo_Simbolo.cadena);
                    resultado.classValor(resultado_final_cadena);
                    return resultado;
                case 73 /* error */:
                    resultado.classRol(Tabla_Enums.tipo_Simbolo.error);
                    resultado.classAcceso(Tabla_Enums.tipo_Acceso.publico);
                    resultado.classIdentificador("33-12");
                    resultado.classTipo(Tabla_Enums.tipo_primitivo_Simbolo.error);
                    resultado.classValor("No es posible sumar un valor del tipo " + valor1.getTipo() + " con un valor tipo " + valor2.getTipo() + ".");
                    return resultado;
                default:
                    resultado.classAcceso = 0 /* publico */;
