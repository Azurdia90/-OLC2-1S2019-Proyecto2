...
var Sentencia_If = /** @class */ (function (_super) {
    ...
    function Sentencia_If(p_expresion, p_etiqueta_verdadera, p_lista_instrucciones) {
        var _this = _super.call(this, 0, 0) || this;
        _this.expresion = p_expresion;
        _this.etiqueta_verdadera = p_etiqueta_verdadera;
        _this.lista_instrucciones = p_lista_instrucciones;
        return _this;
    }
    Sentencia_If.prototype.ejecutar = function (entorno_local) {
        try {
