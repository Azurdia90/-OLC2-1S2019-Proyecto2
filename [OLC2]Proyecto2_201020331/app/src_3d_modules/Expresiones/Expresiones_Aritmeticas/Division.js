...
var Division = /** @class */ (function (_super) {
    ...
    Division.prototype.ejecutar = function (entorno_local) {
        var resultado;
        try {
            ...
            var res_division;
            var new_tam;
            if (valor1.classValor != 0) {
                res_division = valor1.classValor / valor2.classValor;
                new_tam = valor1.classTam + valor2.classTam;
                resultado = new Simbolo_1.default(res_division, new_tam);
                return resultado;
            }
            else {
                return new Simbolo_1.default(-33, -12);
