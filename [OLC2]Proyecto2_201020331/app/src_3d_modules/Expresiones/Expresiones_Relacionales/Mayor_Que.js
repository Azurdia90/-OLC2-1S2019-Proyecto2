...
var Mayor_Que = /** @class */ (function (_super) {
    ...
    Mayor_Que.prototype.ejecutar = function (entorno_local) {
        var resultado;
        try {
            ...
            var res_mayor_que;
            var new_tam;
            res_mayor_que = valor1.classValor > valor2.classValor;
            new_tam = 1;
            resultado = new Simbolo_1.default(res_mayor_que == true ? 1 : 0, new_tam);
            return resultado;
        }
        catch (Error) {
