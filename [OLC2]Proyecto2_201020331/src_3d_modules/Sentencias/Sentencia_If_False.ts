...
class Sentencia_If_False extends Instruccion
{
    private expresion : Expresion;
    private etiqueta_falsa : String;
    private lista_instrucciones : Array<Instruccion>;

    constructor(p_expresion : Expresion, p_etiqueta_falsa : String, p_lista_instrucciones : Array<Instruccion>)
    {
        super(0,0);
        this.expresion = p_expresion;
        this.etiqueta_falsa = p_etiqueta_falsa;
...
export default Sentencia_If_False;