...
{
    private tabla_multiplicacion : tipo_operacion [][] = [
                                                ...
                                                /*entero*/  [tipo_operacion.error,tipo_operacion.error,tipo_operacion.multiplicacion_entero,tipo_operacion.multiplicacion_decimal,tipo_operacion.multiplicacion_entero_caracter,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error],
                                                /*decimal*/ [tipo_operacion.error,tipo_operacion.error,tipo_operacion.multiplicacion_decimal,tipo_operacion.multiplicacion_decimal,tipo_operacion.multiplicacion_decimal_caracter,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error],
                                                /*caracter*/[tipo_operacion.error,tipo_operacion.error,tipo_operacion.multiplicacion_caracter_entero,tipo_operacion.multiplicacion_caracter_decimal,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error],
    ...
    {
        var tipo_multiplicacion : tipo_operacion;
        ...
        {            
            ...
            {
                case tipo_operacion.multiplicacion_entero:
                    ...
                    return resultado;
                case tipo_operacion.multiplicacion_decimal:
                    ...
                    return resultado;      
                case tipo_operacion.multiplicacion_entero_caracter:
                    ...
                    return resultado;
                case tipo_operacion.multiplicacion_caracter_entero:                    
                    ...
                    return resultado;
                case tipo_operacion.multiplicacion_decimal_caracter:
                    ...
                    return resultado;         
                case tipo_operacion.multiplicacion_caracter_decimal:
