...
{
    private tabla_igual_que : tipo_operacion [][] = [
                                            /*nulo*/    [tipo_operacion.igual_nulo,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error],
                                            /*booleano*/[tipo_operacion.igual_nulo,tipo_operacion.igual_booleano,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error,tipo_operacion.error],
                                            /*entero*/  [tipo_operacion.igual_nulo,tipo_operacion.error,tipo_operacion.igual_numerico,tipo_operacion.igual_numerico,tipo_operacion.igual_numerico_caracter,tipo_operacion.igual_numerico_caracter,tipo_operacion.error,tipo_operacion.error],
                                            /*decimal*/ [tipo_operacion.igual_nulo,tipo_operacion.error,tipo_operacion.igual_numerico,tipo_operacion.igual_numerico,tipo_operacion.igual_numerico_caracter,tipo_operacion.igual_numerico_caracter,tipo_operacion.error,tipo_operacion.error],
                                            /*caracter*/[tipo_operacion.igual_nulo,tipo_operacion.error,tipo_operacion.igual_caracter_numerico,tipo_operacion.igual_caracter_numerico,tipo_operacion.igual_caracter,tipo_operacion.igual_caracter,tipo_operacion.error,tipo_operacion.error],
                                            /*cadena*/  [tipo_operacion.igual_nulo,tipo_operacion.error,tipo_operacion.igual_caracter_numerico,tipo_operacion.igual_caracter_numerico,tipo_operacion.igual_caracter,tipo_operacion.igual_caracter,tipo_operacion.error,tipo_operacion.error],
    ...
    {
        var tipo_igual_que: tipo_operacion;
