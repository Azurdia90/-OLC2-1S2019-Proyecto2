...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,9],$V1=[1,13],$V2=[1,11],$V3=[1,12],$V4=[1,14],$V5=[1,15],$V6=[1,16],$V7=[1,17],$V8=[1,18],$V9=[1,20],$Va=[1,21],$Vb=[1,22],$Vc=[1,23],$Vd=[1,24],$Ve=[1,25],$Vf=[1,26],$Vg=[1,27],$Vh=[1,28],$Vi=[1,29],$Vj=[1,30],$Vk=[1,31],$Vl=[1,32],$Vm=[7,13,14,15,16,17,18,19,22,23,24,25,27,28],$Vn=[7,13,14,15,16,17,18,19,22,23,24,25],$Vo=[7,13,14,17,18,19,22,23,24,25],$Vp=[7,17,18,19,22,23,24,25],$Vq=[7,22,23,24,25];
